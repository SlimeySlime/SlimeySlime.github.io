    ...
    <div className="flex flex-col p-12 mobile:p-4 justify-start itmes-start overflow-y-auto">
        ...
        <div className="mt-4">
            <p className="leading-8">
                ...
                내가 잘하고 싶은 일을 찾기 위해 안드로이드 앱, 유니티, 파이썬, 웹 개발 등 <br/>
                여러가지 시도를 해보면서 프로그래밍을 공부했습니다.<br />
                그리고 갤러리 페이지를 만드는 과정에서, 웹 풀스택 개발을 접하고 <br />
        ...
        <hr  className="mt-4?"/>
        <div className="mt-4 grid grid-cols-6 mobile:grid-cols-3">
            <p>2014.02 ~ 2019.03</p>
            <div className="col-span-5 mobile:col-span-2 mb-2">
                <p>충북대학교 사회학과 (학사)</p>
            </div>
            <p>2017.02 ~ 2019.03</p>
            <div className="col-span-5 mobile:col-span-2 mb-2">
